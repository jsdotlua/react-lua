...
export type Store = EventEmitter<{
	...
	assertMapSizeMatchesRootCount: (self: Store, map: Map<any, any>, mapName: string) -> (),
	...
	_adjustParentTreeWeight: (self: Store, parentElement: Element | nil, weightDelta: number) -> (),
	...
	onBridgeOverrideComponentFilters: (self: Store, componentFilters: Array<ComponentFilter>) -> (),
...
export type ProfilerStore = EventEmitter<{
	...
	_store: Store,
	getCommitData: (self: ProfilerStore, rootID: number, commitIndex: number) -> CommitDataFrontend,
	...
	profilingData: (self: ProfilerStore, value: ProfilingDataFrontend?) -> ...ProfilingDataFrontend?,
