...
function ProfilingCache.new(profilerStore: ProfilerStore): ProfilingCache
	local profilingCache: ProfilingCache = (setmetatable({}, ProfilingCache) :: any) :: ProfilingCache
	...
	function profilingCache:getFiberCommits(ref: { fiberID: number, rootID: number }): Array<number>
	...
	function profilingCache:getFlamegraphChartData(ref: {
		...
		local commitIndex, commitTree, rootID = ref.commitIndex, ref.commitTree, ref.rootID
	...
	function profilingCache:getInteractionsChartData(ref: { rootID: number }): InteractionsChartData
