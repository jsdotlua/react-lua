-- upstream: https://github.com/facebook/react/blob/8af27aeedbc6b00bc2ef49729fc84f116c70a27c/packages/scheduler/src/__tests__/SchedulerProfiling-test.js
--[[**
	...
	describe("Scheduler", function()
		...
		local function stopProfilingAndPrintFlamegraph()
			...
			for _, task_ in tasksValues do
				...
				local labelColumn = string.format("Task %d [%s]", task_.id, priorityLevelToString(task_.priorityLevel))
...
!!! Main thread              │
		...
		it("automatically stops profiling and warns if event log gets too big", function()
			Scheduler.unstable_Profiling.startLoggingProfilingEvents()
			-- deviation: use toWarvDev matcher below instead of overriding console global
