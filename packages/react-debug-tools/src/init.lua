-- upstream: https://github.com/facebook/react/blob/v17.0.2/packages/react-debug-tools/index.js
--[[*
...
-- deviation START: simplify and re-export types
-- local Packages --[[ COMMENT: must define Packages module ]]
