...
describe("TracingSubscriptions", function()
	...
	describe("enabled", function()
		...
		describe("error handling", function()
			it("should cover onInteractionTraced/onWorkStarted within", function()
				SchedulerTracing.unstable_trace(firstEvent.name, currentTime, function()
					...
					jestExpect(SchedulerTracing.unstable_getCurrent()).toMatchInteractions({ firstEvent })
		...
		it("calls lifecycle methods for wrap", function()
			...
			jestExpect(
				onInteractionScheduledWorkCompleted.mock.calls[1] --[[ ROBLOX adaptation: added 1 to array index ]][1] --[[ ROBLOX adaptation: added 1 to array index ]]
			).toMatchInteraction(firstEvent)
			jestExpect(
				onInteractionScheduledWorkCompleted.mock.calls[2] --[[ ROBLOX adaptation: added 1 to array index ]][1] --[[ ROBLOX adaptation: added 1 to array index ]]
