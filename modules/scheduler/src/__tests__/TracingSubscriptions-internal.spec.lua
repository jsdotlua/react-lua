	...
	describe("TracingSubscriptions", function()
		...
		describe("enabled", function()
			...
			describe("error handling", function()
				it("should cover onInteractionTraced/onWorkStarted within", function()
					SchedulerTracing.unstable_trace(
						...
						function()
							...
							jestExpect(secondSubscriber.onWorkStarted).toHaveBeenCalledTimes(
								3
							)
						end
					)
				...
				it("should cover onWorkStopped within trace", function()
					SchedulerTracing.unstable_trace(
						...
						function()
							...
							-- It should call other subscribers despite the earlier error
							jestExpect(secondSubscriber.onWorkStopped).toHaveBeenCalledTimes(
								1
							)
						end
					)
				...
				it(
					"should cover onInteractionScheduledWorkCompleted within trace",
					function()
						SchedulerTracing.unstable_trace(
							firstEvent.name,
							currentTime,
				...
				it("should cover onWorkScheduled within wrap", function()
					SchedulerTracing.unstable_trace(
						...
						function()
							...
							jestExpect(secondSubscriber.onWorkScheduled).toHaveBeenCalledTimes(
								1
							)
						end
					)
			...
			it("calls lifecycle methods for trace", function()
				...
				SchedulerTracing.unstable_trace(firstEvent.name, currentTime, function()
					...
					jestExpect(onInteractionScheduledWorkCompleted).toHaveBeenCalledTimes(
						1
					)
					jestExpect(onInteractionScheduledWorkCompleted).toHaveBeenLastNotifiedOfInteraction(
						secondEvent
					...
					SchedulerTracing.unstable_trace(
						...
						function()
							...
							SchedulerTracing.unstable_trace(
								...
								function()
									wrappedTwo =
										SchedulerTracing.unstable_wrap(fnTwo, threadID)
								end
							)
						end
					)
			...
			it(
				...
				function()
					...
					SchedulerTracing.unstable_trace(
						...
						function()
							wrappedOne =
								SchedulerTracing.unstable_wrap(unwrappedOne, threadID)
							wrappedTwo =
								SchedulerTracing.unstable_wrap(unwrappedTwo, threadID)
						end
					)
					jestExpect(onInteractionTraced).toHaveBeenCalledTimes(1)
					jestExpect(onInteractionScheduledWorkCompleted).never.toHaveBeenCalled()
