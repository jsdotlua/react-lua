...
return function()
	...
	describe("ReactUpdates", function()
		...
		itSKIP("should queue mount-ready handlers across different roots", function()
		...
		itSKIP("calls componentWillReceiveProps setState callback properly", function()
		...
		itSKIP("unmounts and remounts a root in the same batch", function()
