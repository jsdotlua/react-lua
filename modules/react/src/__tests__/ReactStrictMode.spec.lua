...
return function()
    ...
    describe('ReactStrictMode', function()
        ...
        it('should invoke setState callbacks twice in DEV', function()
            ...
            -- ROBLOX deviation: using ReactNoop in place of ReactDOM
            ReactNoop.act(function()
                ReactNoop.render(React.createElement(StrictMode, nil, React.createElement(ClassComponent)))
            end)
    ...
    describe('Concurrent Mode', function()
        ...
        it('should warn about unsafe legacy lifecycle methods anywhere in the tree', function()
            ...
            function AsyncRoot:render()
                return React.createElement('div', nil, React.createElement(Wrapper, nil, React.createElement(Foo)), React.createElement('div', nil, React.createElement(Bar), React.createElement(Foo)))
            end
    ...
    describe('symbol checks', function()
        ...
        it('should switch from StrictMode to a Fragment and reset state', function()
            ...
            local function ParentComponent(props)
                ...
                return(function()
                    if useFragment then
                        return React.createElement(Fragment, nil, React.createElement(ChildComponent))
                    end

                    return React.createElement(StrictMode, nil, React.createElement(ChildComponent))
                end)()
            end
