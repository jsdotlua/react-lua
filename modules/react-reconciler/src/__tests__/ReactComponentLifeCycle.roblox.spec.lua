...
return function()
	...
	it(
		"should pass the return value from getSnapshotBeforeUpdate to didUpdate",
		function()
			local log = {}
	...
	describe("Naming conventions", function()
		...
		local function testWithComponentKind(component: string)
			it(
				"should warn if using old Roact didMount naming in " .. component,
				function()
			...
			it(
				"should warn if using old Roact willUpdate naming in " .. component,
				function()
					local Foo = React[component]:extend("Foo")
					jestExpect(function()
			...
			it(
				"should warn if using old Roact didUpdate naming in " .. component,
				function()
					local Foo = React[component]:extend("Foo")
					jestExpect(function()
