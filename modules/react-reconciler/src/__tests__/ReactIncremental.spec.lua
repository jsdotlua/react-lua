    ...
    describe('ReactIncremental', function()
        ...
        it('can cancel partially rendered work and restart', function()
            ...
            local function Foo(props)
                ...
                return React.createElement('div', nil, React.createElement(Bar, nil, props.text), React.createElement(Bar, nil, props.text))
            end
        ...
        it('should call callbacks even if updates are aborted', function()
            ...
            function Foo:render()
                return React.createElement('div', nil, React.createElement('div', nil, self.state.text), React.createElement('div', nil, self.state.text2))
            end
        ...
        xit('can deprioritize unfinished work and resume it later', function()
            ...
            local function Foo(props)
                ...
                return React.createElement('div', nil,
                    ...
                    React.createElement(LegacyHiddenDiv, {mode = 'hidden',},
        ...
        xit('can deprioritize a tree from without dropping work', function()
            ...
            local function Foo(props)
                ...
                return React.createElement('div', nil, React.createElement(Bar, nil, props.text), React.createElement(LegacyHiddenDiv, {
                    mode = 'hidden',
                }, React.createElement(Middle, nil, props.text)), React.createElement(Bar, nil, props.text), React.createElement(LegacyHiddenDiv, {
                    mode = 'hidden',
                }, React.createElement(Middle, nil, 'Footer')))
            end
        ...
        xit('provides context when reusing work', function()
            ...
            ReactNoop.render(React.createElement(Intl, {
                locale = 'fr',
            }, React.createElement(ShowLocale, nil), React.createElement(LegacyHiddenDiv, {
                mode = 'hidden',
