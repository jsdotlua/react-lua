...
return function()
	...
	describe("ReactLazy", function()
		...
		xit(
			"should error with a component stack naming the resolved component",
			function()
				...
				function ErrorBoundary:componentDidCatch(error_, errMessage)
					componentStackMessage =
						normalizeCodeLocInfo(errMessage.componentStack)
		...
		xit(
			"should error with a component stack containing Lazy if unresolved",
			function()
				local componentStackMessage
				local LazyText = lazy(function()
					return {
