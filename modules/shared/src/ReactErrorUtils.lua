...
local function makeReactErrorUtils(invokeGuardedCallbackImpl)
...
local Default = makeReactErrorUtils(invokeGuardedCallbackImpl)

return {
	makeWithArgs = makeReactErrorUtils,
	Default = Default,
}