...
return function(config)
	...
	local shouldYieldToHost = config.shouldYieldToHost
	local getCurrentTime = config.getCurrentTime
	local forceFrameRate = config.forceFrameRate
	local requestPaint = config.requestPaint
